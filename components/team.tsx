        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
          <div className="space-y-2">
            ...
            <p className="max-w-[900px] text-white/60 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              ...
              <span className="text-cyan-400 font-semibold">Kyrat</span> a reality.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {displayedTeam.map((member) => {
            ...
            return (
              ...
              >
                <Avatar className="h-24 w-24 md:h-28 md:w-28 border-4 border-cyan-400/50 hover:border-cyan-400 transition-colors duration-300">
                  {image && (
                    <AvatarImage
                      src={image.imageUrl}
                      alt={member.name}
                  ...
                  <AvatarFallback className="bg-gradient-to-br from-cyan-900 to-cyan-700 text-white text-2xl font-bold">
